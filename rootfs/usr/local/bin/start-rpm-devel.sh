...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211131219-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  start-rpm-devel.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 13, 2022 12:19 EST
# @@File             :  start-rpm-devel.sh
# @@Description      :  script to start rpm-devel
...
HOSTNAME="${HOSTNAME:-casjaysdev-rpm-devel}"
